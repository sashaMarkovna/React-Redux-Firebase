    ...
    return (
      <div className="dropdown">
        <ul className="dropdown__list container" id="dropdownList">
          <li>
            <NavLink to="/" className="nav__link">Main Feed
              <i className="fas fa-th nav__link-icon" />
            </NavLink>
          </li>
          <li>
            <NavLink to="/community" className="nav__link">Community
              <i className="fas fa-users nav__link-icon" />
            </NavLink>
          </li>
          <li>
            <NavLink to="/create/post" className="nav__link">New Post
          ...
          <li>
            <NavLink to={`/user/${this.props.userId}`} className="nav__link">Messages
              <i className="far fa-comment nav__link-icon" />
            </NavLink>
          </li>
          <li>
            <NavLink to={`/user/${this.props.userId}/settings`} className="nav__link">Settings
              <i className="fas fa-cogs nav__link-icon" />
            </NavLink>
          </li>
          <li>
            <p onClick={this.handleLogOut} className="nav__link nav__link--logout">Log out
